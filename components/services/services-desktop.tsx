            ...
            <div className="mx-auto max-w-7xl relative z-10 px-8">
                <div className="mb-24 flex items-end justify-between gap-10">
                    <div className="max-w-3xl focus-in">
                        <div className="luxury-badge mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            <Sparkles className="w-4 h-4 text-primary" />
                            Nuestros Servicios
                        </div>
                        <h2 className="cinematic-heading-lg animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
                            {header.title} <br />
                            <span className="text-primary">{header.highlight}</span>
                        </h2>
                    </div>
                    <p className="text-muted-foreground max-w-sm text-lg font-light leading-relaxed border-l border-primary/30 pl-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
                        {header.description}
                    </p>
                </div>
                        ...
                        {services.map((service, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="group cinematic-card animate-in fade-in slide-in-from-bottom-8 duration-1000"
