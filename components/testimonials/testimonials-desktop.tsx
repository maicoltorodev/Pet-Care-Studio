...
export function TestimonialsDesktop({ content, testimonials }: { content: ContentItem[], testimonials: Testimonial[] }) {
    ...
    return (
        <section id="testimonios" className="cinematic-section border-b border-white/5 py-32">
            ...
            <div className="mx-auto max-w-7xl relative z-10 px-8">
                <div className="mb-24 flex flex-col items-center text-center focus-in">
                    ...
                    <h2 className="cinematic-heading-md">
                        {header.title} <br /> <span className=" text-primary">{header.highlight}</span>
                    </h2>
                </div>
                ...
                {testimonials.length > 0 ? (
                    <div className="grid gap-10 lg:grid-cols-3">
                        {testimonials.map((testimonial, index) => (
                            <div
                                key={testimonial.id}
                                className="group cinematic-card hover:-translate-y-2 transition-transform duration-700 flex flex-col"
                ...
                <div className="mt-32 flex flex-col items-center gap-10">
                    <div className="group inline-flex items-center gap-6 rounded-full bg-secondary/30 backdrop-blur-xl px-10 py-5 border border-border/40 shadow-2xl hover:bg-secondary/50 transition-colors duration-500">
